...
df_result_5= pd.DataFrame({"Valor fitness_4":vector_result[4000000:5000000]})
df_result_6= pd.DataFrame({"Valor fitness_4":vector_result[5000000:6000000]})
df_result_7= pd.DataFrame({"Valor fitness_4":vector_result[6000000:7000000]})
df_result_8= pd.DataFrame({"Valor fitness_5":vector_result[7000000:pop_tam]})
filename="C:\\Users\\tr5568\\OneDrive - Axalta\\Desktop\\DAYANA\\PERSONAL\\" \
                        "MÁSTER INGENIERÍA COMPUTACIONAL Y SISTEMAS INTELIGENTES\\TFM\\RESULTADOS\\Resultados_baseline_11y21y31.xlsx"
...
writer.save()
df_result_6.to_excel(writer,sheet_name="Resultados_6", index=False)
writer.save()
df_result_7.to_excel(writer,sheet_name="Resultados_7", index=False)
writer.save()
df_result_8.to_excel(writer,sheet_name="Resultados_8", index=False)
writer.save()